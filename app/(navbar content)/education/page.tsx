...
export default function Education() {
    return (
        <section className="flex items-center justify-center min-h-screen bg-black text-white p-4 py-[10rem] md:py-[16rem]">
                ...
                <div className="space-y-12">

                    {
                        EducationArray.map((item, index) => (
                            <div data-aos={`${index%2==0?"fade-right":"fade-left"}`} data-aos-delay={`${index*200}`} key={index} className='p-3 sm:p-4 md:p-8 rounded-lg shadow-lg space-y-4 md:space-y-8 text-white border border-gray-800'>
